...
int main(int argc, char** argv){
    ...
    igraph_set_attribute_table(&igraph_cattribute_table); //experimental attribute handler: . Please note that the attribute handler must be attached before you call any other igraph functions, otherwise you might end up with graphs without attributes and an active attribute handler, which might cause unexpected program behaviour. 
