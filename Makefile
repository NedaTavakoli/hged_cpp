...
all:
	...
	$(CXX) $(CPPFLAGS) -D BCFTOOLSPATH=$(BCFTOOLS_INSTALL) -D SAMTOOLSPATH=$(SAMTOOLS_INSTALL) -m64 -o $(TARGET_DIR)/reachable_subgraph -I $(GUROBI_INSTALL)/include/ -I src/ext -L  $(GUROBI_INSTALL)/lib/ src/reachable_subgraph.cpp -lgurobi_c++ $(GUROBI_INSTALL)/lib/libgurobi91.so -lm -lz -lpthread
